...
import pytest
from thedang.shells.tcsh import Tcsh
...
class TestTcsh(object):
    ...
    def Popen(self, mocker):
        mock = mocker.patch('thedang.shells.tcsh.Popen')
        mock.return_value.stdout.read.return_value = (
            b'dang\teval $(thedang $(fc -ln -1))\n'
            b'l\tls -CF\n'
            b'la\tls -A\n'
            b'll\tls -alF')
        return mock
    ...
    def test_app_alias(self, shell):
        assert 'setenv TF_SHELL tcsh' in shell.app_alias('dang')
        assert 'alias dang' in shell.app_alias('dang')
        assert 'alias DANG' in shell.app_alias('DANG')
