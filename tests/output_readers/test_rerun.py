...
from thedang.output_readers import rerun


class TestRerun(object):
    def setup_method(self, test_method):
        self.patcher = patch('thedang.output_readers.rerun.Process')
    ...
    @patch('thedang.output_readers.rerun._wait_output', return_value=False)
    @patch('thedang.output_readers.rerun.Popen')
    ...
    @patch('thedang.output_readers.rerun._wait_output')
    ...
    @patch('thedang.output_readers.rerun._kill_process')
    ...
    @patch('thedang.output_readers.rerun.logs')
