...
from thedang import ui
from thedang.types import CorrectedCommand
...
def patch_get_key(monkeypatch):
    def patch(vals):
        vals = iter(vals)
        monkeypatch.setattr('thedang.ui.get_key', lambda: next(vals))
...
class TestSelectCommand(object):
    ...
    def test_without_commands(self, capsys):
        ...
        assert capsys.readouterr() == ('', 'No dangs given\n')
