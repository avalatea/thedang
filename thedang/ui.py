...
class CommandSelector(object):
    ...
    def __init__(self, commands):
        """:type commands: Iterable[thedang.types.CorrectedCommand]"""
    ...
    @property
    def value(self):
        """:rtype thedang.types.CorrectedCommand"""
...
def select_command(corrected_commands):
    ...
    :type corrected_commands: Iterable[thedang.types.CorrectedCommand]
    :rtype: thedang.types.CorrectedCommand | None

    """
    try:
        selector = CommandSelector(corrected_commands)
    except NoRuleMatched:
        logs.failed('No dangs given' if get_alias() == 'dang'
                    else 'Nothing found')
        return
